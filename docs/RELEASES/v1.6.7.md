...
**Improvements:**
- Reduced complexity across security scanning code
- Extracted reusable components for better testability
- Improved separation of concerns

**New Files:**
- `api/pipeline/security_scanner.py` - SecurityScanner extraction
...
**v1.6.6** (Nov 26, 2025)
- Refactor: Code quality improvements (complexity reduction)
